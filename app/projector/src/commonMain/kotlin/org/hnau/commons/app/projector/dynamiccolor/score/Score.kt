 ...
 */
package org.hnau.commons.app.projector.dynamiccolor.score
...
object Score {
    ...
    fun score(
        ...
        // total count.
        val colorsHct: MutableList<Hct> = arrayListOf()
        ...
        val scoredHcts: MutableList<ScoredHCT> = arrayListOf()
        ...
        // 15 degree minimum.
        val chosenColors: MutableList<Hct> = arrayListOf()
