 ...
 */
package org.hnau.commons.app.model.color.dynamic.hct
    ...
    private constructor(
        ...
        companion object {
            ...
            internal fun fromXyzInViewingConditions(
                ...
                // hue
                val atan2 = atan2(b, a)
                val atanDegrees = atan2 * 180 / PI
                val hue = MathUtils.sanitizeDegreesDouble(atanDegrees)
                val hueRadians = hue * PI / 180
                ...
                val eHue = 0.25 * (cos(huePrime * PI / 180 + 2.0) + 3.8)
