...
class FormModel(
    ...
    val flag: InputModel<Boolean, Nothing, Boolean, InputType.Flag> = skeleton.flag.toModel(
        scope = scope,
    )


    val decimal: InputModel<String, UnableParseStringToDecimalError, BigDecimal, InputType.Edit<UnableParseStringToDecimalError, BigDecimal>> =
        skeleton.decimal.toModel(
            scope = scope,
        )


    val integer: InputModel<String, UnableParseStringToIntegerError, BigInteger, InputType.Edit<UnableParseStringToIntegerError, BigInteger>> =
        skeleton.integer.toModel(
            scope = scope,
        )


    val text: InputModel<String, StringIsTooShort, String, InputType.Edit<StringIsTooShort, String>> =
        skeleton.text.toModel(
            scope = scope,
        ) {
